...
def main():
    ...
    parser.add_argument('--train_epoch', type=int, default=100,help='Maximum training epoch') # original at 400
    parser.add_argument('--lr', type=float, default=0.0002, help='Initial learning rate')
    parser.add_argument('--optim_step_size', type=int, default=20,help='Learning rate decay step size') # original at 80
